...
<div class="d-flex justify-content-between align-items-center">
    <h4 class="py-3 mb-4"><span class="text-muted fw-light">Forms /</span> Custom Script Form</h4>
...
<div class="content-wrapper">
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Create Custom Script</h4>
                    <div class="mt-4">
                        <form class="forms-sample" action="{{ route('custom-script.store') }}" method="POST"
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea name="content" class="form-control @error('content') is-invalid @enderror" id="" cols="" rows="">{{ old('content') }}</textarea>
                                        @error('content')
                                        <div style="color: red;">{{ $message }}</div>
                                        @enderror
                                    </div>
