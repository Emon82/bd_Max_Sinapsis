            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div style="display: flex;justify-content: end;"><a href="{{ route('clinical.create') }}"
...
@push('scripts')
    ...
    <script>
        ...
        function statusChange(id) {
            let url = '{{ route('clinical.status', ':id') }}';
            $.ajax({
                type: "GET",
        ...
        function deleteItem(id) {
            let url = '{{ route('clinical.destroy', ':id') }}';
