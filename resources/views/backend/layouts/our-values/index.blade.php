            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div style="display: flex;justify-content: end;"><a href="{{ route('our-values.create') }}"
...
@push('scripts')
    ...
    <script>
        ...
        function statusChange(id) {
            let url = '{{ route('our-values.status', ':id') }}';
            $.ajax({
                type: "GET",
        ...
        function deleteItem(id) {
            let url = '{{ route('our-values.destroy', ':id') }}';
