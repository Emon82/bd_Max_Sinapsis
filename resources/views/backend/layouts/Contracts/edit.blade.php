                            ...
                            <div class="col-6">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control @error('description_EESS') is-invalid @enderror"
                                        name="description_EESS" id="description_EESS" rows="5">{{ old('description_EESS', $project->description_EESS) }}</textarea>
                            ...
                            <div class="col-6">
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control @error('description_IINN') is-invalid @enderror"
                                        name="description_IINN" id="description_IINN" rows="5">{{ old('description_IINN', $project->description_IINN) }}</textarea>
