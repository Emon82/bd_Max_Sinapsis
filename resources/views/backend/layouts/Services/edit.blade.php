            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" action="{{ route('services.update', ['id' => $data->id]) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control @error('title_eess') is-invalid @enderror"
                                               name="title_eess" value="{{ $data->title_eess }}">
                                        @error('title_eess')
                                ...
                                <div class="col-6">
                                    <div class="form-group mb-3">
                                        <label class="form-label required">Title (Other Language)</label>
                                        <input type="text" class="form-control @error('title_iinn') is-invalid @enderror"
                                               name="title_iinn" value="{{ $data->title_iinn }}">
                                        @error('title_iinn')
                                            <div style="color: red;">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea class="form-control @error('description_eess') is-invalid @enderror"
                                                  name="description_eess" id="description_eess">{{ $data->description_eess }}</textarea>
                                ...
                                <div class="col-6">
                                    <div class="form-group mb-3">
                                        <label class="form-label required">Description (Other Language)</label>
                                        <textarea class="form-control @error('description_iinn') is-invalid @enderror"
                                                  name="description_iinn" id="description_iinn">{{ $data->description_iinn }}</textarea>
                            ...
                            <a href="{{ route('services.index') }}" class="btn btn-danger mt-2">Cancel</a>
