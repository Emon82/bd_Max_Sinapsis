        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div style="display: flex;justify-content: end;"><a href="{{ route('faq.create') }}"
...
<script>
    ...
    function statusChange(id) {
        // Generate the URL by replacing ":id" in the route with the actual ID
            ...
            success: function(resp) {
                ...
                if (resp.success) {
                    Swal.fire({
                        position: "center",
                        icon: "success",
                        title: resp.message || "Published Successfully",
                ...
                // Handle other cases (e.g., unpublished status)
                else {
                    Swal.fire({
                        position: "center",
                        icon: "success",
                        title: resp.message || "Unpublished Successfully",
                        showConfirmButton: false,
                        timer: 1500
                    });
                }
